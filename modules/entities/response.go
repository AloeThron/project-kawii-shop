...
import (
	"github.com/AloeThron/project-kawii-shop/packages/kawiilogger"
...
func (r *Response) Success(code int, data any) IResponse {
	r.StatusCode = code
	r.Data = data
	kawiilogger.InitKawaiiLogger(r.Context, &r.Data, code).Print()
	return r
}
func (r *Response) Error(code int, tractId, msg string) IResponse {
	...
	r.IsError = true
	kawiilogger.InitKawaiiLogger(r.Context, &r.ErrorRes, code).Print()
	return r
}
